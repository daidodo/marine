...
{
    {
        ...
        ASSERT_LT(0, shm.init(PATH, 1))<<__Shm::ErrMsg();
        ...
        __Shm shm;
        ASSERT_FALSE(shm.valid());
        ASSERT_LT(0, shm.init(PATH, 0, ADDR, 0621))<<__Shm::ErrMsg();
        ASSERT_TRUE(shm.valid());
...
{
    {
        ...
        __Shm shm;
        ASSERT_FALSE(shm.valid());
        ASSERT_LT(0, shm.init(key))<<__Shm::ErrMsg();
        ASSERT_TRUE(shm.valid());
        ...
        __Shm shm;
        ASSERT_FALSE(shm.valid());
        ASSERT_LT(0, shm.init(key, ADDR, 0621))<<__Shm::ErrMsg();
        ASSERT_TRUE(shm.valid());
